...
import { PromptInput, PromptInputBody, PromptInputFooter, PromptInputMessage, PromptInputSubmit, PromptInputTextarea, PromptInputTools } from "./ai-elements/prompt-input";
              ...
              switch (p.type) { 
                case "text": 
                  ...
                  case "tool-getProductDetails":
                        return (
                          <AgentProductCard key={p.toolCallId} invocation={p} />
                        );                    
                default: 
                  return null; 
              } 
